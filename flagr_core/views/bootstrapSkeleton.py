...
__CHEETAH_genTime__ = 1362168239.991393
__CHEETAH_genTimestamp__ = 'Fri Mar  1 13:03:59 2013'
__CHEETAH_src__ = 'interface/templates/bootstrapSkeleton.tmpl'
__CHEETAH_srcLastModified__ = 'Fri Mar  1 11:32:54 2013'
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <![endif]-->
        <link rel="stylesheet" href="''')
        _v = VFFSL(SL,"resources",True) # u'$resources' on line 26, col 38
        if _v is not None: write(_filter(_v, rawExpr=u'$resources')) # from line 26, col 38.
        write(u'''/css/main.css">

        <script src="''')
        _v = VFFSL(SL,"resources",True) # u'$resources' on line 28, col 22
        if _v is not None: write(_filter(_v, rawExpr=u'$resources')) # from line 28, col 22.
            ...
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav">
''')
        if VFFSL(SL,"user.loggedIn",True): # generated from line 47, col 29
            write(u'''                                <li ''')
            if VFFSL(SL,"page",True) in ('labels', 'settings', 'flags'): # generated from line 48, col 37
                write(u'''class="active"''')
            write(u'''><a href="/user/dashboard"><i class="icon-dashboard"></i></a></li>
''')
        else: # generated from line 49, col 29
            write(u'''                                <li ''')
            if VFFSL(SL,"page",True)=='home': # generated from line 50, col 37
                write(u'''class="active"''')
            write(u'''><a href="/"><i class="icon-home"></i></a></li>
''')
        write(u'''                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle ''')
        if VFFSL(SL,"page",True)=='search': # generated from line 53, col 68
            write(u'''active''')
        write(u'''" data-toggle="dropdown"><i class="icon-search"></i></a>
                        ...
                        <ul class="nav pull-right">
                            <li class="dropdown">
''')
        if not VFFSL(SL,"user.loggedIn",True): # generated from line 68, col 33
            write(u'''                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Ohia, Stranger! <i class="icon-chevron-down"></i></a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="/auth/register">Request an invite</a></li>
                                    </ul>
''')
        elif VFFSL(SL,"user.loggedIn",True): # generated from line 81, col 33
            write(u'''                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Heya, ''')
            _v = VFFSL(SL,"user.username",True) # u'$user.username' on line 82, col 102
            if _v is not None: write(_filter(_v, rawExpr=u'$user.username')) # from line 82, col 102.
...
''')
        if VFFSL(SL,"user.alerts",True): # generated from line 103, col 21
            write(u'''                        ''')
            _v = VFFSL(SL,"user.alerts",True) # u'$user.alerts' on line 104, col 25
            if _v is not None: write(_filter(_v, rawExpr=u'$user.alerts')) # from line 104, col 25.
            write(u'''
''')
        write(u'''                </div>
''')
        if VFFSL(SL,"page",True) in ('labels', 'settings', 'flags'): # generated from line 107, col 17
            write(u'''                    <!-- Start tabs and page header -->
                    <div class="row">
                        <div class="offset1 span5">
                            <h3><i class="icon-dashboard"></i> Dashboard <small><b>Your ''')
            _v = VFFSL(SL,"page",True) # u'$page' on line 111, col 89
            if _v is not None: write(_filter(_v, rawExpr=u'$page')) # from line 111, col 89.
            write(u'''</b></small></h3>
                        </div>
                        <div class="span5 tabs-below">
                            <ul class="nav nav-tabs">
                                <li ''')
            if VFFSL(SL,"page",True)=="flags": # generated from line 115, col 37
                write(u''' class="active"''')
            write(u'''><a href="#flags"><i class="icon-flag"></i></a></li>
                                <li ''')
            if VFFSL(SL,"page",True)=="labels": # generated from line 116, col 37
                write(u''' class="active"''')
            write(u'''><a href="#labels"><i class="icon-tags"></i></a></li>
                                <li ''')
            if VFFSL(SL,"page",True)=="settings": # generated from line 117, col 37
                write(u''' class="active"''')
...
''')
        write(u'''                <div class="row">
                    <div class="offset1 span10">
                        ''')
        _v = VFFSL(SL,"body",True) # u'$body' on line 126, col 25
        if _v is not None: write(_filter(_v, rawExpr=u'$body')) # from line 126, col 25.
        write(u'''
                    </div>
                    ''')
        _v = VFFSL(SL,"getVar",False)('rightExtra', '') # u"$getVar('rightExtra', '')" on line 128, col 21
        if _v is not None: write(_filter(_v, rawExpr=u"$getVar('rightExtra', '')")) # from line 128, col 21.
        write(u'''
                </div>
            </div>
        ...
        _v = VFFSL(SL,"resources",True) # u'$resources' on line 145, col 63
        if _v is not None: write(_filter(_v, rawExpr=u'$resources')) # from line 145, col 63.
        write(u'''/js/jquery-1.9.1.min.js"><\\/script>\')</script>

        <script src="''')
        _v = VFFSL(SL,"resources",True) # u'$resources' on line 147, col 22
        if _v is not None: write(_filter(_v, rawExpr=u'$resources')) # from line 147, col 22.
        write(u'''/js/bootstrap.min.js"></script>

        <script src="''')
        _v = VFFSL(SL,"resources",True) # u'$resources' on line 149, col 22
        if _v is not None: write(_filter(_v, rawExpr=u'$resources')) # from line 149, col 22.
        write(u'''/js/main.js"></script>
''')
        if VFFSL(SL,"getVar",False)('scripts', ''): # generated from line 150, col 9
            for script in VFFSL(SL,"scripts",True): # generated from line 151, col 13
                write(u'''                <script src="''')
                _v = VFFSL(SL,"resources",True) # u'$resources' on line 152, col 30
                if _v is not None: write(_filter(_v, rawExpr=u'$resources')) # from line 152, col 30.
                write(u'''/js/''')
                _v = VFFSL(SL,"script.js",True) # u'$script.js' on line 152, col 44
                if _v is not None: write(_filter(_v, rawExpr=u'$script.js')) # from line 152, col 44.
                write(u'''"></script>
''')
        write(u"""
        <!-- <script>
