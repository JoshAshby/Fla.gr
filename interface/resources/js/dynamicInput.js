...
(function() {
  ...
  $(function() {
    ...
    */
    ...
    if (base !== "") {
      ...
      for (_i = 0, _len = labels.length; _i < _len; _i++) {
        label = labels[_i];
        $("#dynamicList").append(labelsCompiledTemplate({
          "label": label
        }));
      }
    }
    ...
    */
    ...
    $("#addInputField").keypress(function(event) {
      if (event.which === 13) {
    ...
    */
    ...
    return $(document).on("click", "#dynamicList>span.label", function() {
