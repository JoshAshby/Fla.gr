from flagr.controllers.indexController import *

#from flagr.controllers.authController import *
#from flagr.controllers.adminController import *
#from flagr.controllers.godController import *
