...
from controllers.admin.users import *
from controllers.admin.indexPosts import *
from controllers.admin.indexNewsCarousel import *
...
<br />
%s
                                        """ % ps.baseAButton("%s Posts"%ps.baseIcon("rss"), link=c.baseURL+"/admin/posts", classes="btn-info")),
                                classes="span3") + ps.baseTextThumbnail(label=ps.baseHeading(ps.baseIcon("play") + " Carousel"),
                                caption=ps.baseParagraph("""
...
<br />
%s
                                        """ % ps.baseAButton("%s Users"%ps.baseIcon("play"), link=c.baseURL+"/admin/users", classes="btn-info")),
                                classes="span3")
