#!/usr/bin/env python
"""
Collection specifically for dealing with a specific users prublic flags
...
class userPublicFlagsCollection(bcc.baseCouchCollection):
    """
    ...
    def __init__(self, userID, couch=c.database.couchServer):
        ...
        self.userID = userID
        self.pattern = "couch:" + self.model._name + ":user:" + self.userID + ":public"
